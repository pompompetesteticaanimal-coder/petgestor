    ...
    return (
        <HashRouter>
            ...
            >
                ...
                {currentView === 'packages' && <PackageControlView clients={clients} appointments={appointments} services={services} onViewPet={(pet, client) => setPetDetailsData({ pet, client })} onUpdateClient={handleUpdateClient} />}
            </Layout>
