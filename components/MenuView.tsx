...
import { Users, Scissors, TrendingUp, TrendingDown, Settings, AlertCircle, Phone, Menu, FileText, ClipboardList } from 'lucide-react';
...
export const MenuView: React.FC<MenuViewProps> = ({ setView, onOpenSettings }) => {
    ...
    const [items, setItems] = useState<MenuItem[]>([
        ...
        { id: 'tasks', label: 'Tarefas', icon: ClipboardList, view: 'tasks', colorClass: 'bg-teal-100 text-teal-600' },
